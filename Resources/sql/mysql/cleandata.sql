...
VALUES (1,'content','<p>This is the clean installation coming with eZ Platform Enterprise Edition. It''s a barebones setup of the platform, an excellent foundation to build upon if you want to start your project from scratch.</p>');
